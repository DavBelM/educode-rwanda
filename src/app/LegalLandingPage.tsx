          ...
          <div style={{ maxWidth: 680, margin: '0 auto', display: 'grid', gap: 20, gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))' }}>
            ...
            <Link to="/terms" style={{ textDecoration: 'none' }}>
              <div className="card pad-lg" style={{ height: '100%', cursor: 'pointer', transition: 'box-shadow .15s' }}>
                <svg style={{ width: 28, height: 28, marginBottom: 14, color: 'var(--text-2)' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <footer className="site-footer">
        <div className="wrap foot">
          <div>
            ...
            <div>© 2026 EduCode Rwanda. Built in Rwanda.</div>
          </div>
