      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <span style={{ color: 'var(--text-3)', fontSize: 15 }}>{isKin && set.title_kin ? set.title_kin : set.title}</span>
        ...
        {/* XP counter */}
        <span className="pill" style={{ fontWeight: 500, fontSize: 15 }}>
          {xpEarned} XP
        </span>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', flex: '0 0 60%', borderRight: '1px solid var(--line)', overflow: 'hidden' }}>
          ...
          <div style={{
            ...
            <button
              className="btn btn-primary"
              style={{ gap: 6, padding: '6px 16px', fontSize: 15, flexShrink: 0 }}
              onClick={handleRun}
              disabled={running}
            >
              {running ? (
        ...
        <div style={{ flex: '0 0 40%', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            ...
            {(['challenge', 'mwarimu'] as const).map(tab => (
              <button
                ...
                style={{
                  ...
                  gap: 6, fontSize: 15, fontWeight: rightTab === tab ? 600 : 400,
          ...
          <div style={{
            ...
            {/* Title */}
            <h2 style={{ color: 'var(--text)', fontSize: 17, fontWeight: 600, marginBottom: 10, lineHeight: 1.4 }}>
              {isKin && challenge.title_kin ? challenge.title_kin : challenge.title}
            </h2>
              ...
              <div>
                ...
                {results.map((r, i) => (
                  <div key={i} className="flex items-start gap-2 mb-2.5">
                    ...
                    <div>
                      <span style={{ color: r.passed ? 'var(--text)' : 'var(--text-2)', fontSize: 15 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontSize: 25, fontWeight: 600, color: 'var(--text)' }}>
            ...
            {/* Test summary */}
            <div className="flex items-center gap-2 justify-center mb-6" style={{ fontSize: 15, color: 'var(--text-2)' }}>
